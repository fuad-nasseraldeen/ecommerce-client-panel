export default function DiscountStar({ size = '48px', fill = '#FF2556', className = 'size-6' }) {
  return (
    <svg
      version='1.0'
      id='Layer_1'
    ...
    >
      ...
      <g id='SVGRepo_tracerCarrier' strokeLinecap='round' strokeLinejoin='round' stroke={fill} strokeWidth='8.83'>
        <path
          fill={fill}
